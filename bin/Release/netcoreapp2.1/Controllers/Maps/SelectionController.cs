...
namespace samplebrowser.Controllers
{
    public partial class MapsController : Controller
    {
        ...
        {
            ViewBag.datasource = Election_Result.GetElectionResults();
            return View();
        }
...
new CountyPopulationData(){ Name= "Wyoming", Population=582658}
        ...
        public class Country_LatLongPoints
        {
                ...
                List<LatLongPoints> countryLatLongPoints = new List<LatLongPoints>
            {
                ...
                new LatLongPoints {Name =  "American Samoa", Latitude = -14.3333, Longitude = -170 },
                new LatLongPoints {Name =  "Andorra", Latitude = 42.5, Longitude = 1.5 },
                ...
                new LatLongPoints {Name =  "Antarctica", Latitude = -90, Longitude = 0 },
                new LatLongPoints {Name =  "Antigua and Barbuda", Latitude = 17.05, Longitude = -61.8 },
                new LatLongPoints {Name =  "Argentina", Latitude = -34, Longitude = -64 },
                new LatLongPoints {Name =  "Armenia", Latitude = 40, Longitude = 45 },
                new LatLongPoints {Name =  "Aruba", Latitude = 12.5, Longitude = -69.9667 },
                ...
                new LatLongPoints {Name =  "Bahrain", Latitude = 26, Longitude = 50.55 },
                new LatLongPoints {Name =  "Bangladesh", Latitude = 24, Longitude = 90 },
                new LatLongPoints {Name =  "Barbados", Latitude = 13.1667, Longitude = -59.5333 },
                ...
                new LatLongPoints {Name =  "Bermuda", Latitude = 32.3333, Longitude = -64.75 },
                ...
                new LatLongPoints {Name =  "Bouvet Island", Latitude = -54.4333, Longitude = 3.4 },
                new LatLongPoints {Name =  "Brazil", Latitude = -10, Longitude = -55 },
                new LatLongPoints {Name =  "British Indian Ocean Territory", Latitude = -6, Longitude = 71.5 },
                ...
                new LatLongPoints {Name =  "Cape Verde", Latitude = 16, Longitude = -24 },
                new LatLongPoints {Name =  "Cayman Islands", Latitude = 19.5, Longitude = -80.5 },
                ...
                new LatLongPoints {Name =  "Christmas Island", Latitude = -10.5, Longitude = 105.6667 },
                ...
                new LatLongPoints {Name =  "Comoros", Latitude = -12.1667, Longitude = 44.25 },
                new LatLongPoints {Name =  "Congo", Latitude = -1, Longitude = 15 },
                new LatLongPoints {Name =  "Cook Islands", Latitude = -21.2333, Longitude = -159.7667 },
                new LatLongPoints {Name =  "Costa Rica", Latitude = 10, Longitude = -84 },
                new LatLongPoints {Name =  "Cote D'Ivoire (Ivory Coast)", Latitude = 8, Longitude = -5 },
                new LatLongPoints {Name =  "Croatia (Hrvatska)", Latitude = 45.1667, Longitude = 15.5 },
                new LatLongPoints {Name =  "Cuba", Latitude = 21.5, Longitude = -80 },
                new LatLongPoints {Name =  "Cyprus", Latitude = 35, Longitude = 33 },
                ...
                new LatLongPoints {Name =  "Falkland Islands", Latitude = -51.75, Longitude = -59 },
                new LatLongPoints {Name =  "Faroe Islands", Latitude = 62, Longitude = -7 },
                ...
                new LatLongPoints {Name =  "French Southern Territories", Latitude = -43, Longitude = 67 },
                new LatLongPoints {Name =  "Gabon", Latitude = -1, Longitude = 11.75 },
                new LatLongPoints {Name =  "Gambia", Latitude = 13.4667, Longitude = -16.5667 },
                ...
                new LatLongPoints {Name =  "Grenada", Latitude = 12.1167, Longitude = -61.6667 },
                new LatLongPoints {Name =  "Guadeloupe", Latitude = 16.25, Longitude = -61.5833 },
                new LatLongPoints {Name =  "Guam", Latitude = 13.4667, Longitude = 144.7833 },
                ...
                new LatLongPoints {Name =  "Heard and McDonald Islands", Latitude = -53.1, Longitude = 72.5167 },
                new LatLongPoints {Name =  "Honduras", Latitude = 15, Longitude = -86.5 },
                new LatLongPoints {Name =  "Hong Kong", Latitude = 22.25, Longitude = 114.1667 },
                ...
                new LatLongPoints {Name =  "Korea (North)", Latitude = 40, Longitude = 127 },
                new LatLongPoints {Name =  "Korea (South)", Latitude = 37, Longitude = 127.5 },
                ...
                new LatLongPoints {Name =  "Laos", Latitude = 18, Longitude = 105 },
                ...
                new LatLongPoints {Name =  "Liechtenstein", Latitude = 47.1667, Longitude = 9.5333 },
                new LatLongPoints {Name =  "Lithuania", Latitude = 56, Longitude = 24 },
                new LatLongPoints {Name =  "Luxembourg", Latitude = 49.75, Longitude = 6.1667 },
                new LatLongPoints {Name =  "Macau", Latitude = 22.1667, Longitude = 113.55 },
                ...
                new LatLongPoints {Name =  "Malta", Latitude = 35.8333, Longitude = 14.5833 },
                new LatLongPoints {Name =  "Marshal Islands", Latitude = 9, Longitude = 168 },
                ...
                new LatLongPoints {Name =  "Mauritius", Latitude = -20.2833, Longitude = 57.55 },
                new LatLongPoints {Name =  "Mayotte", Latitude = -12.8333, Longitude = 45.1667 },
                new LatLongPoints {Name =  "Mexico", Latitude = 23, Longitude = -102 },
                new LatLongPoints {Name =  "Micronesia", Latitude = 6.9167, Longitude = 158.25 },
                new LatLongPoints {Name =  "Moldova", Latitude = 47, Longitude = 29 },
                new LatLongPoints {Name =  "Monaco", Latitude = 43.7333, Longitude = 7.4 },
                new LatLongPoints {Name =  "Mongolia", Latitude = 46, Longitude = 105 },
                new LatLongPoints {Name =  "Montserrat", Latitude = 16.75, Longitude = -62.2 },
                ...
                new LatLongPoints {Name =  "Nauru", Latitude = -0.5333, Longitude = 166.9167 },
                new LatLongPoints {Name =  "Nepal", Latitude = 28, Longitude = 84 },
                new LatLongPoints {Name =  "Netherland Antilles", Latitude = 12.25, Longitude = -68.75 },
                ...
                new LatLongPoints {Name =  "Niue", Latitude = -19.0333, Longitude = -169.8667 },
                new LatLongPoints {Name =  "Norfolk Island", Latitude = -29.0333, Longitude = 167.95 },
                new LatLongPoints {Name =  "Northern Marianas Islands", Latitude = 15.2, Longitude = 145.75 },
                new LatLongPoints {Name =  "Norway", Latitude = 62, Longitude = 10 },
                new LatLongPoints {Name =  "Oman", Latitude = 21, Longitude = 57 },
                new LatLongPoints {Name =  "other", Latitude = 0, Longitude = 0 },
                new LatLongPoints {Name =  "Pakistan", Latitude = 30, Longitude = 70 },
                new LatLongPoints {Name =  "Palau", Latitude = 7.5, Longitude = 134.5 },
                ...
                new LatLongPoints {Name =  "Peru", Latitude = -10, Longitude = -76 },
                new LatLongPoints {Name =  "Philippines", Latitude = 13, Longitude = 122 },
                new LatLongPoints {Name =  "Pitcairn", Latitude = 0, Longitude = 0 },
                ...
                new LatLongPoints {Name =  "Reunion", Latitude = -21.1, Longitude = 55.6 },
                ...
                new LatLongPoints {Name =  "Saint Helena", Latitude = -15.9333, Longitude = -5.7 },
                new LatLongPoints {Name =  "Saint Kitts and Nevis", Latitude = 17.3333, Longitude = -62.75 },
                new LatLongPoints {Name =  "Saint Lucia", Latitude = 13.8833, Longitude = -61.1333 },
                new LatLongPoints {Name =  "Saint Pierre and Miquelon", Latitude = 46.8333, Longitude = -56.3333 },
                new LatLongPoints {Name =  "Saint Vincent and the Grenadines", Latitude = 13.25, Longitude = -61.2 },
                new LatLongPoints {Name =  "Samoa", Latitude = -13.5833, Longitude = -172.3333 },
                new LatLongPoints {Name =  "San Marino", Latitude = 43.7667, Longitude = 12.4167 },
                ...
                new LatLongPoints {Name =  "Seychelles", Latitude = -4.5833, Longitude = 55.6667 },
                new LatLongPoints {Name =  "Sierra Leone", Latitude = 8.5, Longitude = -11.5 },
                new LatLongPoints {Name =  "Singapore", Latitude = 1.3667, Longitude = 103.8 },
                new LatLongPoints {Name =  "Slovak Republic", Latitude = 48.6667, Longitude = 19.5 },
                new LatLongPoints {Name =  "Slovenia", Latitude = 46, Longitude = 15 },
                new LatLongPoints {Name =  "Solomon Islands", Latitude = -8, Longitude = 159 },
                new LatLongPoints {Name =  "Somalia", Latitude = 10, Longitude = 49 },
                new LatLongPoints {Name =  "South Africa", Latitude = -29, Longitude = 24 },
                new LatLongPoints {Name =  "South Georgia and the South Sandwich Islands", Latitude = -54.5, Longitude = -37 },
                ...
                new LatLongPoints {Name =  "Svalbard and Jan Mayen Islands", Latitude = 78, Longitude = 20 },
                ...
                new LatLongPoints {Name =  "Tokelau", Latitude = -9, Longitude = -172 },
                new LatLongPoints {Name =  "Tonga", Latitude = -20, Longitude = -175 },
                ...
                new LatLongPoints {Name =  "Turks and Caicos Islands", Latitude = 21.75, Longitude = -71.5833 },
                new LatLongPoints {Name =  "Tuvalu", Latitude = -8, Longitude = 178 },
                new LatLongPoints {Name =  "Uganda", Latitude = 1, Longitude = 32 },
                ...
                new LatLongPoints {Name =  "Venezuela", Latitude = 8, Longitude = -66 },
                new LatLongPoints {Name =  "Vietnam", Latitude = 16, Longitude = 106 },
                new LatLongPoints {Name =  "Virgin Islands (British)", Latitude = 18.3333, Longitude = -64.8333 },
                new LatLongPoints {Name =  "Virgin Islands (US)", Latitude = 0, Longitude = 0 },
                new LatLongPoints {Name =  "Wallis and Futuna Islands", Latitude = -13.3, Longitude = -176.2 },
                new LatLongPoints {Name =  "Western Sahara", Latitude = 24.5, Longitude = -13 },
                ...
                new LatLongPoints {Name =  "Zambia", Latitude = -15, Longitude = 30 },
                new LatLongPoints {Name =  "Zimbabwe", Latitude = 0, Longitude = 0 }
            };
