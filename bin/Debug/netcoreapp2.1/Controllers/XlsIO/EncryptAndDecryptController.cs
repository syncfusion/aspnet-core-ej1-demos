    ...
    public partial class XlsIOController : Controller
    {
        ...
        public ActionResult EncryptAndDecrypt(string button, string SaveOption)
        {
            ...
            else if (button == "Encrypt Document")
            {
                ...
                FileStream inputStream = new FileStream(basePath + @"/XlsIO/Encrypt.xlsx", FileMode.Open, FileAccess.Read);
            ...
            else
            {
                ...
                FileStream inputStream = new FileStream(basePath + @"/XlsIO/EncryptedWorkbook.xlsx", FileMode.Open, FileAccess.Read);
