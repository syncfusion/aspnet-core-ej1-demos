...
$(function () {
    ...
    $("#learnmore").ejButton({
        ...
        click: function (evt, args) {
           window.open("//ej2.syncfusion.com/home/aspdotnetcore.html?utm_source=ej1&utm_medium=referral&utm_campaign=migrate", "_blank");
           showEJ2PopUp();
        }
    });
    $("#popupclose").ejButton({
    ...
    function resizeFooter() {
        var footerText = ($(window).width() < 445) ? "\u00A9 2001-2018 Syncfusion Inc." : "Copyright \u00A9 2001-2018 Syncfusion Inc.";
...
function ej2Samples(e) {
    window.open("//ej2.syncfusion.com/home/aspdotnetcore.html?utm_source=ej1&utm_medium=banner&utm_campaign=migrate","_blank");
}
