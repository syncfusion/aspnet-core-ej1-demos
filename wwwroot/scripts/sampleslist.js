...
window.SamplesList = [
    ...
    {
        "name": "TreeGrid", "id": "TreeGrid", "childcount": "1", "Group": "GRIDS", "controller": "TreeGrid", "type": "update", "action": "Default",
        ...
        "samples": [
            ...
            { "id": "5", "name": "Exporting", "controller": "TreeGrid", "action": "TreeGridExport", "childcount": "0", "type": "new" }
        ]
    },
	{
    ...
    },
    {
     ...
     {
         "name": "Gantt", "id": "Gantt", "childcount": "1", "Group": "DATA VISUALIZATION", "controller": "Gantt", "type": "update", "action": "Default",
         ...
         "samples": [
             ...
             { "id": "4", "name": "Exporting", "controller": "Gantt", "action": "GanttExport", "childcount": "0" ,"type":"new" }
         ]
     },
     {
             ...
             { "id": "1", "name": "Getting Started", "controller": "Pdf", "action": "Default", "childcount": "0" },
             {
                                         ...
                                         { "id": "1", "name": "Job Application", "controller": "Pdf", "action": "JobApplication", "childcount": "0" }                                        
                                        ...
                                        },  
                                          {
										   ...
										   { "id": "3", "name": "RTL Text", "controller": "Pdf", "action": "RTLSupport", "childcount": "0"},
											{ "id": "4", "name": "OpenType Font", "controller": "Pdf", "action": "OpenTypeFont", "childcount": "0", "type": "new" }
                                                ]
                                            },										
                                          {
                                          ...
                                          },                                            
                                        {
                                         ...
                                         { "id": "2", "name": "Digital Signature", "controller": "Pdf", "action": "DigitalSignature", "childcount": "0"}
                                           ...
                                           { "id": "1", "name": "PDF Conformance", "controller": "Pdf", "action": "Conformance", "childcount": "0", "type": "new" }]
                                              },                                                 
                                                       {
             ...
             { "id": "1", "name": "Getting Started", "controller": "Presentation", "action": "Default", "childcount": "0" },
              { "id": "2", "name": "Chart", "controller": "Presentation", "action": "Chart", "childcount": "0" },
               { "id": "3", "name": "Slide", "controller": "Presentation", "action": "Slide", "childcount": "0" },
				...
				{ "id": "7", "name": "Connector", "controller": "Presentation", "action": "Connector", "childcount": "0", "type": "new" },
				{ "id": "8", "name": "Create Animation", "controller": "Presentation", "action": "CreateAnimation", "childcount": "0"  },
				{ "id": "9", "name": "Modify Animation", "controller": "Presentation", "action": "ModifyAnimation", "childcount": "0"  },
				{ "id": "10", "name": "Slide Transition", "controller": "Presentation", "action": "SlideTransition", "childcount": "0"  }
         ]
     },
	 {
                ...
                "id": "3", "name": "CHARTS", "controller": "XlsIO", "action": "ChartWorksheet", "childcount": "1",  "samples": [
                 ...
                 },
				 {
                     "id": "7", "name": "Export", "controller": "XlsIO", "action": "ExcelToPDF", "childcount": "1", samples: [
                         { "id": "1", "name": "Excel To PDF", "controller": "XlsIO", "action": "ExcelToPDF","childcount": "0", "type": "new" },
         ...
         {
             "name": "PivotGrid", "id": "PivotGrid", "type": "", "childcount": "1", "Group": "BUSINESS INTELLIGENCE", "controller": "PivotGrid", "action": "Default",
		 ...
		 {
             "name": "PivotClient", "id": "PivotClient", "type": "", "childcount": "1", "Group": "BUSINESS INTELLIGENCE", "controller": "PivotClient", "action": "Default",
             ...
             "kburl": "https://www.syncfusion.com/kb/aspnetcore",
             "samples": [
                 { "id": "1", "name": "Relational", "controller": "PivotClient", "action": "Default", "childcount": "0", "type": "" },
