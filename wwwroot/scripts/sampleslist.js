...
window.SamplesList = [
    ...
    },
    {
        ...
        "samples": [
            ...
            { "id": "5", "name": "Exporting", "controller": "TreeGrid", "action": "TreeGridExport", "childcount": "0" }
        ]
    },
	{
    ...
    },
    {
    ...
    },
     {
         ...
         "samples": [
             ...
             { "id": "4", "name": "Exporting", "controller": "Gantt", "action": "GanttExport", "childcount": "0" }
         ]
     },
     {
     ...
     },
     {
         ...
         "samples": [
             { "id": "1", "name": "Getting Started", "controller": "Pdf", "action": "Default", "childcount": "0" },
             {
                                         ...
                                         { "id": "2", "name": "ZUGFeRD Invoice", "controller": "Pdf", "action": "Zugferd", "childcount": "0", "type": "new" }										 
                                            ]
                                        },  
                                          {
                                          ...
                                          },                                            
                                        {
                                         ...
                                         { "id": "2", "name": "Digital Signature", "controller": "Pdf", "action": "DigitalSignature", "childcount": "0"}
										   ...
										   { "id": "8", "name": "XFA Form Creation", "controller": "Pdf", "action": "XFAFormCreation", "childcount": "0", "type": "new" },
                                           { "id": "9", "name": "XFA Form Filling", "controller": "Pdf", "action": "XFAFormFilling", "childcount": "0", "type": "new" }]
                                              },
                                              {
                                                  "id": "10", "name": "Conformance", "controller": "Pdf", "action": "Conformance", "childcount": "1", "samples": [
                                           { "id": "1", "name": "PDF Conformance", "controller": "Pdf", "action": "Conformance", "childcount": "0", "type": "update" }]
                                              },                                                 
                                                       {
         ...
         "samples": [
			{
             ...
             },
			 {
                 "id": "2", "name": "Conversion", "controller": "Presentation", "action": "PPTXToImage", "childcount": "1", "samples": [
                     { "id": "1", "name": "PPTX To Image", "controller": "Presentation", "action": "PPTXToImage", "childcount": "0", "type": "new" },
                     { "id": "2", "name": "PPTX To PDF", "controller": "Presentation", "action": "PPTXToPDF", "childcount": "0", "type": "new" }
                 ]
             },
			 {
	 ...
	 {
         "name": "DocIO", "id": "DocIO", "childcount": "1", "Group": "FILE FORMATS", "controller": "DocIO", "action": "SalesInvoice", "type": "update",
         ...
         "samples": [
             ...
             },
             {
				 ...
				 { "id": "1", "name": "Word To PDF", "controller": "DocIO", "action": "WordToPDF", "type": "update", "childcount": "0" },
             ...
             },
             {
                 "id": "12", "name": "Chart", "controller": "DocIO", "action": "PieChart", "childcount": "1", "samples": [                     
                     { "id": "1", "name": "Pie Chart", "controller": "DocIO", "action": "PieChart", "type": "update", "childcount": "0" },
                     { "id": "2", "name": "Bar Chart", "controller": "DocIO", "action": "BarChart", "type": "update", "childcount": "0" }
                 ]
             },
             {
	 ...
	 },
		 {
             ...
             "samples": [
                ...
                "id": "1", "name": "GETTING STARTED", "controller": "XlsIO", "action": "Create", "childcount": "1",  "samples": [
                 ...
                 },
				 {
                     "id": "2", "name": "PRODUCT SHOWCASE", "controller": "XlsIO", "action": "AttendanceTracker", "childcount": "1", "samples": [
                         { "id": "1", "name": "Attendance Tracker", "controller": "XlsIO", "action": "AttendanceTracker", "childcount": "0", "type": "new" }
                     ]
                 },
                 {
                     "id": "3", "name": "FORMATTING", "controller": "XlsIO", "action": "FormatCells", "childcount": "1", "samples": [
                         ...
                         { "id": "2", "name": "Conditional Formatting", "controller": "XlsIO", "type": "update", "action": "ConditionalFormatting", "childcount": "0" }
                     ]
                 },
				 {
                "id": "4", "name": "CHARTS", "controller": "XlsIO", "action": "ChartWorksheet", "childcount": "1",  "samples": [
                 ...
                 {
                     "id": "7", "name": "DATA BINDING", "controller": "XlsIO", "action": "CLRObjects", "childcount": "1", "samples": [
                 ...
                 },
                 {
                     "id": "10", "name": "BUSINESS INTELLIGENCE", "controller": "XlsIO", "action": "Tables", "childcount": "1", "samples": [
                         { "id": "1", "name": "Tables", "controller": "XlsIO", "action": "Tables", "type": "update", "childcount": "0" }
                     ]
                 },
                 {
		 ...
		 },
         {
             ...
             "kburl": "https://www.syncfusion.com/kb/aspnetcore",
             "samples": [
                 { "id": "1", "name": "Relational", "controller": "PivotGrid", "action": "Default", "childcount": "0", "type": "" },
                 ...
                 { "id": "5", "name": "Exporting", "controller": "PivotGrid", "action": "Exporting", "childcount": "0", "type": "update" }
             ]
         },
         {
    ...
    },
    {
        ...
        "type": "preview",
        "samples": [
            { "id": "1", "name": "Default Functionalities", "controller": "ReportDesigner", "action": "Default", "childcount": "0", "type": "update" }
        ]
    }
];
