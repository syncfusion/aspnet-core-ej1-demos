...
window.SamplesList = [
    ...
    },
    {
     ...
     {
         "name": "PDF", "id": "Pdf", "childcount": "1", "Group": "FILE FORMATS", "controller": "Pdf", "action": "Default",
             ...
             { "id": "1", "name": "Getting Started", "controller": "Pdf", "action": "Default", "childcount": "0" },
             {
                                          ...
                                          },                                            
                                        {
                                         ...
                                         { "id": "2", "name": "Find Text", "controller": "Pdf", "action": "FindText", "childcount": "0" },
										  ...
										  { "id": "4", "name": "TIFF To PDF", "controller": "Pdf", "action": "TiffToPDF", "childcount": "0" }]
                                        }, 
                                             {
     ...
     },
	 {
         ...
         {
             "name": "PivotGrid", "id": "PivotGrid", "childcount": "1", "Group": "BUSINESS INTELLIGENCE", "controller": "PivotGrid", "action": "Default",
             ...
             "kburl": "https://www.syncfusion.com/kb/aspnetcore",
             "samples": [
                 { "id": "1", "name": "Relational", "controller": "PivotGrid", "action": "Default", "childcount": "0"},
                 ...
                 { "id": "4", "name": "Paging", "controller": "PivotGrid", "action": "Paging", "childcount": "0"},
                 { "id": "5", "name": "Exporting", "controller": "PivotGrid", "action": "Exporting", "childcount": "0"}
             ]
         },
         {
             "name": "PivotChart", "id": "PivotChart", "childcount": "1", "Group": "BUSINESS INTELLIGENCE", "controller": "PivotChart", "action": "Default",
             ...
             "samples": [
                 ...
                 { "id": "4", "name": "Multiple Axes", "controller": "PivotChart", "action": "MultipleAxes", "childcount": "0" },
                 { "id": "5", "name": "Exporting", "controller": "PivotChart", "action": "Exporting", "childcount": "0" }
             ]
         },
         {
		 ...
		 {
             "name": "PivotClient", "id": "PivotClient", "childcount": "1", "Group": "BUSINESS INTELLIGENCE", "controller": "PivotClient", "action": "Default",
             ...
             "kburl": "https://www.syncfusion.com/kb/aspnetcore",
             "samples": [
                 { "id": "1", "name": "Relational", "controller": "PivotClient", "action": "Default", "childcount": "0" },
                 { "id": "2", "name": "OLAP", "controller": "PivotClient", "action": "Olap", "childcount": "0" },
                 { "id": "3", "name": "Calculated Members", "controller": "PivotClient", "action": "CalculatedMembers", "childcount": "0" },
                 { "id": "3", "name": "Paging", "controller": "PivotClient", "action": "Paging", "childcount": "0" }
             ]
         },
		 {
